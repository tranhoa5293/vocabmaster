...
public class LessonService {
    ...
    @Cacheable(value = "lessons", key = "#collectionId")
    ...
    public boolean toggleFavorite(Long lessonId) {
        ...
        return self.toggleFavoriteForUser(user, lesson.getCollection().getId(), lesson);
    }

    @CacheEvict(value = "lessons", key = "#collectionId")
    @Transactional
    public boolean toggleFavoriteForUser(User user, Long collectionId, Lesson lesson) {
